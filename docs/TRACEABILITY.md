...
| REQ-SEC-001 hostile input isolation | [`security-and-trust-boundaries.md`](specs/security-and-trust-boundaries.md), ADR-0003, ADR-0012 | `vaultc::{snapshot,parse,plan,provider,approval,compile,pack,verify}` and CLI guards; strict raw archive names and complete archive accounting | 18 security plus 22 normalization/archive cases; ZIP Unicode-extra/raw-name, PAX, all-member count, full-stream ratio, containment, provenance, Canvas, provider, and VaultPack attacks | implemented; fuzz/property campaigns and platform matrix pending |
| REQ-SDK-001 inspect-to-explain workflow | [`public-sdk-and-cli.md`](specs/public-sdk-and-cli.md), ADR-0001, ADR-0011 | `vaultc::VaultCompiler`, `vaultc::augmentation`, `vaultc-cli`, `vaultc-protocol`; exhaustive plan error-family mapping | CLI full lifecycle and exits; 14 SDK augmentation/replay cases; 3 CLI replay cases; SDK/CLI plan, recording, approved artifact, and VaultPack parity | implemented for the Rust/CLI V1 surface on macOS arm64; other language bindings and platform matrix pending |
...
- `vaultc`: 15 unit, 5 Canvas, 4 generated-provenance, 22
  normalization/archive, 5 pack, 8 pipeline, 5 provider/approval, 14 SDK
  augmentation/replay, 18 security, and 9 typed-provenance tests;
- `vaultc-cli`: 12 unit, 3 augmentation/replay, and 7 lifecycle tests;
